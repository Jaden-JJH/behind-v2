...
export function IssuesCarousel({ issues }: IssuesCarouselProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="pt-4 relative h-[290px]">
          <div
        ...
        {issues.length > 1 && (
          <>
            <button
              onClick={handlePrevious}
              className={`absolute left-2 top-[145px] -translate-y-1/2 transition-all duration-300 ${
            ...
            <button
              onClick={handleNext}
              className={`absolute right-2 top-[145px] -translate-y-1/2 transition-all duration-300 ${
                isTouched ? 'opacity-100' : 'opacity-0'
              }`}
              aria-label="Next"
            >
