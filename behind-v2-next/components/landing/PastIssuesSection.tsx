      ...
      <CardContent>
        <div className="space-y-2">
          {issues.map((issue, idx) => (
            <div
              key={issue.id}
              className="group relative p-3.5 sm:p-4 rounded-xl border border-slate-100 bg-slate-50/50 hover:bg-white hover:border-slate-200 transition-all cursor-pointer"
